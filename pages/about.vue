  ...
  <main id="main-content">
    <article class="editorial">
      ...
      <p>
        ...
        impairment seems to take many forms and its mechanisms, undoubtedly
        multiple, are being explored. Certain signs and symptoms plead for a
        direct viral attack of the nervous system: anosmia, meningitis and
        temporal necrotizing encephalitis resembling that of herpes (Moriguchi
        et al. 2020, Poyiadji et al. 2020).
      </p>
      <p>
        The detection of viral particles in the endothelium of the brain vessels
        argues for this direct role of the virus (Paniz-Mondolfi et al. 2020)
        and could explain the occurrence of strokes in young people (Oxley et
        al. 2020). Neuropathological studies are still few.
      </p>
      <p>
        ...
        associated with micro- spotting (Coolen et al. 2020). The hypothesis of
        secondary immune encephalitis has been raised in the face of multiple
        lesions of the white matter suggestive of ADEM (Reichard et al. 2020).
      </p>
      <p>
        Using postmortem MRI, subcortical micro and macro bleeds were reported
        (Coolen et al. 2020). Here, we propose a study combining ex vivo imaging
        by MRI and neuropathological study to elucidate the nature of the
        lesions observed in COVID + patients, their specificity, their
      ...
      <p>
        ...
        comparison and the characterisation of brain lesions linked to the viral
        infection.
      </p>
      <p>
        Our project should produce a new description of the anatomical
        structures affected by the infection in the central nervous system, and
        in particular those related to the brain vascular system.
      </p>
      <p>
        ...
        combined with the collection of testimonies from relatives on the wishes
        of the deceased and their information on the use of samples for
        research.
      </p>
      <p>
